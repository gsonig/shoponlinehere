module Spree
  module FrontendHelper
    ...
    def breadcrumbs(taxon, separator="&nbsp;")
      ...
      crumbs = [content_tag(:li, link_to(Spree.t(:home), spree.root_path, itemprop: "url"), itemscope: "itemscope", itemtype: "http://data-vocabulary.org/Breadcrumb")]
      if taxon
        crumbs << content_tag(:li, link_to(Spree.t(:products), spree.products_path, itemprop: "url"), itemscope: "itemscope", itemtype: "http://data-vocabulary.org/Breadcrumb")
        crumbs << taxon.ancestors.collect { |ancestor| content_tag(:li, link_to(ancestor.name , seo_url(ancestor), itemprop: "url"), itemscope: "itemscope", itemtype: "http://data-vocabulary.org/Breadcrumb") } unless taxon.ancestors.empty?
        crumbs << content_tag(:li, taxon.name, class: 'active', itemscope: "itemscope", itemtype: "http://data-vocabulary.org/Breadcrumb")
      else
        crumbs << content_tag(:li, Spree.t(:products), class: 'active', itemscope: "itemscope", itemtype: "http://data-vocabulary.org/Breadcrumb")
      end
      crumb_list = content_tag(:ol, raw(crumbs.flatten.map{|li| li.mb_chars}.join), class: 'breadcrumb')
      content_tag(:div, crumb_list, id: 'breadcrumbs', class: 'breadcrumbs')
    end
